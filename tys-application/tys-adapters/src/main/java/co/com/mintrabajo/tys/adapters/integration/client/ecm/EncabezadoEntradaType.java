...
public class EncabezadoEntradaType {
    ...
    @XmlElement(name = "Canal", required = true ,namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String canal;
    @XmlElement(name = "PeticionFecha", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar peticionFecha;
    @XmlElement(name = "Usuario", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
