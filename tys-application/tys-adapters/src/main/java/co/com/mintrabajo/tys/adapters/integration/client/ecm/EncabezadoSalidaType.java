...
public class EncabezadoSalidaType {
    ...
    @XmlElement(name = "PeticionId", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String peticionId;
    @XmlElement(name = "RtaCodigo", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String rtaCodigo;
    @XmlElement(name = "RtaDescripcion", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String rtaDescripcion;
    @XmlElement(name = "Criticidad", required = true,namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String criticidad;
    @XmlElement(name = "RtaCodigoHost", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
    protected String rtaCodigoHost;
    @XmlElement(name = "RtaDescripcionHost", required = true, namespace = "http://soaint.com/Servicios/Base/EncabezadosSOA")
